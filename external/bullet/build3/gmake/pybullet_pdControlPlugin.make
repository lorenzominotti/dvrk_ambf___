...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/Release/pybullet_pdControlPlugin
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/libpybullet_pdControlPlugin_gmake_x64_release.so
  DEFINES   += -DPHYSICS_IN_PROCESS_EXAMPLE_BROWSER
  INCLUDES  += -I../../examples/SharedMemory/plugins/pdControlPlugin -I../../src -I../../examples -I../../examples/ThirdPartyLibs
...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/pybullet_pdControlPlugin
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/libpybullet_pdControlPlugin_gmake_x64_debug.so
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking pybullet_pdControlPlugin
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning pybullet_pdControlPlugin
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
