...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/Release/pybullet_collisionFilterPlugin
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/libpybullet_collisionFilterPlugin_gmake_x64_release.so
  DEFINES   += -DPHYSICS_IN_PROCESS_EXAMPLE_BROWSER
  INCLUDES  += -I../../examples/SharedMemory/plugins/collisionFilterPlugin -I../../src -I../../examples -I../../examples/ThirdPartyLibs
...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/pybullet_collisionFilterPlugin
  TARGETDIR  = ../../bin
  TARGET     = $(TARGETDIR)/libpybullet_collisionFilterPlugin_gmake_x64_debug.so
...
$(TARGET): $(GCH) $(OBJECTS) $(LDDEPS) $(RESOURCES)
	@echo Linking pybullet_collisionFilterPlugin
	$(SILENT) $(LINKCMD)
	$(POSTBUILDCMDS)
...
clean:
	@echo Cleaning pybullet_collisionFilterPlugin
ifeq (posix,$(SHELLTYPE))
	$(SILENT) rm -f  $(TARGET)
	$(SILENT) rm -rf $(OBJDIR)
else
